...
{/* ==========iconfuntioncreat========== */}
  ...
  <ul className="hidden md:flex space-x-7 md:space-x-8 transition">
   ...
   <button className={`${active=== '/logi' ?'bg-yellow-200 rounded-lg text-black px-3 py-1 font-medium':'hidden md:block font-medium hover:bg-yellow-200 bg-white text-black px-3 py-1 rounded-lg'}`}>
   Login
   </button>
  </Link>
